/*
 * Class: StringUtils
 * Description:字符串操作工具类，提供常用的字符串操作方法
 * Version: 1.0
 */
...
public class StringUtils {
	 ...
	 * 
	 * @param str
	 *            the String to impl, may be null
	...
	public static String formatBoolToYesNo(String targetValue) {
		if("1".equals(targetValue)
				||"y".equalsIgnoreCase(targetValue)
	 ...
	 * @return
	 */
	public static String encodeConvert(String text, String fromEncode, String toEncode) {
		
		if (null != text) {
			try {
				text = new String(text.getBytes(fromEncode), toEncode);
